            ...
            <div className="mt-8">
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid border-b w-full mt-8 grid-cols-2 gap-16">
                        <button
                            // className="pb-4 focus:text-orange-400 font-medium border-b-2 border-orange-500"
                            className={cls(
                            ...
                            method === "phone"
                                ? (
                                    <div className="flex rounded-md shadow-sm">
                                        ...
                                        <input
                                            id="input"
                                            className="apperance-none w-full px-3 py-2 border border-gray-300 rounded-md rounded-l-none shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                            type="number"
                                            required/>
                                    </div>
                                )
